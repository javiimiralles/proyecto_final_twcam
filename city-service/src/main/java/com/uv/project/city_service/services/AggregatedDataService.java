    ...
    public AggregatedData aggregateData() {
        ...
        for (Aparcamiento aparcamiento : aparcamientos) {
            ...
            if (eventos == null || eventos.isEmpty()) {
                logger.warning("No se encontraron eventos para el aparcamiento con ID: " + aparcamiento.getId());
                return null;
            }
            ...
            if (lecturas == null || lecturas.isEmpty()) {
                logger.warning("No se encontraron lecturas para la estación con ID: " + estacionMasCercana.getId());
                return null;
            }
